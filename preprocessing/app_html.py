...
# ---------- 1. Partition ----------
print("=== Partitioning HTML ===")
elements = partition_html(filename=HTML_FILE, include_metadata=True)
...
# ---------- 4. Export to JSON ----------
source_name = os.path.splitext(os.path.basename(HTML_FILE))[0]
...
if pages:
    ...
    print("\n=== No page numbers (HTML has no pages) ===")
